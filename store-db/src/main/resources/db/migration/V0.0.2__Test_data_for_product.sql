...
INSERT INTO product (c_category_id, name, price, discount, availability_on_command, description, care, added_at) VALUES (3, 'Valentina dress', 13.99, 0.9, true, ARRAY['Mesh body suit with dropped arm holes', '84% Nylon / 16% Spandex'], ARRAY['Hand rinse, dry in shade only', 'Avoid rough surfaces, lotions, sunscreens, and overly chlorinated pools', 'Suits should be worn with care'], NOW());
